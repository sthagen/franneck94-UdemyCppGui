...
std::string Calender::GetFileExtension(std::string_view filename)
{
...
void Calender::SaveToFile(std::string_view filename)
{
...
void Calender::LoadFromFile(std::string_view filename)
{
